      ...
      <header className="relative flex-none bg-slate-950 border-b border-slate-800 px-4 md:px-5 py-3 flex items-center justify-between gap-4 md:gap-6">
        ...
        <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-2">
          <button
            ...
            className="text-xs font-semibold uppercase tracking-wider px-4 py-1.5 rounded-md border border-slate-700 bg-slate-900/60 text-slate-300 hover:bg-slate-800 hover:text-slate-100 transition-colors"
          >
            About
          </button>
          <button
            ...
            className={`text-xs font-semibold uppercase tracking-wider px-4 py-1.5 rounded-md border transition-colors ${
              updatesOpen
      ...
      <div className="flex-1 min-h-0 flex flex-col md:flex-row overflow-hidden">
        <div className="flex-1 min-h-[240px] md:min-h-0 relative">
          <Map
            ...
            onSelect={(wref) => {
              setSelectedWref(wref);
              if (wref) setUpdatesOpen(false);
            }}
